...
testdb.connect(function(error: any){
    if (error) {
      console.error(error);
    } else {
...
app.get('/products', function (req: any, res: any) {
    ...
    testdb.query(command, (err: any, data: any) => {
        if(err) {
            console.log(err)
...
app.post('/addproduct', function (req: any, res: any) {
    ...
    testdb.query(command, [valueToUpdate], (err: any, data: any) => {
        if(err) {
            console.log(err)
...
app.post('/deleteproduct', function (req: any, res: any) {
